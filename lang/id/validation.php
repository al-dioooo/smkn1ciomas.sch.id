...
return [
    ...
    'attributes' => [
        ...
        'status_of_residence' => 'status kepemilikan rumah',
        'live_with' => 'tinggal bersama',
        'parent_name' => 'nama orang tua',
        'parent_status' => 'status orang tua',
        'parent_place_of_birth' => 'tempat lahir orang tua',
        'parent_date_of_birth' => 'tanggal lahir orang tua',
        'parent_education' => 'pendidikan orang tua',
        'parent_profession' => 'pekerjaan orang tua',
        'parent_income' => 'penghasilan orang tua',
        'parent_liabilities' => 'tanggungan orang tua',
        'parent_phone' => 'telepon orang tua',
        'parent_address' => 'alamat orang tua',
        'school_before' => 'sekolah sebelumnya',
        'registration_path' => 'jalur pendaftaran',
        'school_certificate_link' => 'ijazah',
        'school_certificate_number' => 'nomor ijazah',
        'birth_certificate_link' => 'kartu keluarga',
        'province' => 'provinsi',
        'city' => 'kota',
        'village' => 'kecamatan',
        'urban village' => 'desa',
