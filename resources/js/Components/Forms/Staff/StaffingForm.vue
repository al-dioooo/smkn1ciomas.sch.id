...
<template>
    <JetFormSection @submitted="updateStaffInformation">
        ...
        <template #description
            >{{
                staff?.auth_data.id === $page.props.user.id ? "Your" : "Staff's"
            }}
            staffing information.</template
        >
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    ...
                    :isError="form.errors.employment_status"
                    type="option"
                    class="block w-full mt-1"
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    id="additional_duty"
                    v-model="form.additional_duty"
                    :isError="form.errors.additional_duty"
                    type="text"
                    class="block w-full mt-1"
                    autocomplete="additional_duty"
                />
                <JetInputError
                    :message="form.errors.additional_duty"
                    class="mt-2"
                />
            </div>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    id="cpns_sk"
                    v-model="form.cpns_sk"
                    :isError="form.errors.cpns_sk"
                    type="number"
                    class="block w-full mt-1"
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    id="cpns_date"
                    v-model="form.cpns_date"
                    :isError="form.errors.cpns_date"
                    type="date"
                    class="block w-full mt-1"
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    id="appointment_sk"
                    v-model="form.appointment_sk"
                    :isError="form.errors.appointment_sk"
                    type="number"
                    class="block w-full mt-1"
                    autocomplete="appointment_sk"
                />
                <JetInputError
                    :message="form.errors.appointment_sk"
                    class="mt-2"
                />
            </div>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    id="appointment_tmt"
                    v-model="form.appointment_tmt"
                    :isError="form.errors.appointment_tmt"
                    type="date"
                    class="block w-full mt-1"
                    autocomplete="appointment_tmt"
                />
                <JetInputError
                    :message="form.errors.appointment_tmt"
                    class="mt-2"
                />
            </div>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    ...
                    v-model="form.appointment_institute"
                    :isError="form.errors.appointment_institute"
                    type="option"
                    class="block w-full mt-1"
                    autocomplete="appointment_institute"
                />
                <JetInputError
                    :message="form.errors.appointment_institute"
                    class="mt-2"
                />
            </div>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    id="source_of_salary"
                    v-model="form.source_of_salary"
                    :isError="form.errors.source_of_salary"
                    type="option"
                    class="block w-full mt-1"
                    autocomplete="source_of_salary"
                />
                <JetInputError
                    :message="form.errors.source_of_salary"
                    class="mt-2"
                />
            </div>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <JetInput
                    id="pns_tmt"
                    v-model="form.pns_tmt"
                    :isError="form.errors.pns_tmt"
                    type="date"
                    class="block w-full mt-1"
