...
<template>
    <JetFormSection @submitted="updateParentInformation">
        ...
        <template #description>{{ student?.auth_data.id === $page.props.user.id ? "Your" : "Student's" }} parent information.</template>

        <template #form>
            <!-- Parent Name -->
            <div class="col-span-6 sm:col-span-3">
                <JetLabel for="parent_name" value="Parent Name" />
            ...
            <div class="col-span-6 sm:col-span-3">
                <JetLabel for="parent_place_of_birth" value="Parent Place of Birth" />
            ...
            <div class="col-span-6 sm:col-span-3">
                <JetLabel for="parent_date_of_birth" value="Parent Date of Birth" />
            ...
            <!-- Parent Address -->
            <div class="col-span-6 sm:col-span-3">
                <JetLabel for="parent_address" value="Parent Address" />
