            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <template v-if="$page.props.user.authenticatable_type === null">
                                    <JetNavLink :href="route('dashboard.student.index')" :active="route().current('dashboard.student.index')">
                                        Student
                                    </JetNavLink>

                                    <JetNavLink :href="route('dashboard.staff.index')" :active="route().current('dashboard.staff.index')">
                                        Staff
                                    </JetNavLink>
                                </template>
                            </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div class="relative ml-3">
                                <!-- Teams Dropdown -->
                                <JetDropdown v-if="$page.props.jetstream.hasTeamFeatures && $page.props.user.current_team != null" align="right" width="60">
                                    <template #trigger>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <template v-if="$page.props.user.authenticatable_type === null">
                            <JetResponsiveNavLink :href="route('dashboard.student.index')" :active="route().current('dashboard.student.index')">
                                Student
                            </JetResponsiveNavLink>

                            <JetResponsiveNavLink :href="route('dashboard.staff.index')" :active="route().current('dashboard.staff.index')">
                                Staff
                            </JetResponsiveNavLink>
                        </template>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <!-- Team Management -->
                            <template v-if="$page.props.jetstream.hasTeamFeatures && $page.props.user.current_team != null">
