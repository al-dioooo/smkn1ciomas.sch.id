...
class UpdateStaffRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'nip' => 'required_if:_updating,"staffing"|number|max:18',
            'nuptk' => 'required_if:_updating,"staffing"|number|max:16',
            'employment_status' => 'required_if:_updating,"staffing"|string|max:255',
            'ptk' => 'required_if:_updating,"staffing"|string|max:255',
            'additional_duty' => 'required_if:_updating,"staffing"|string|max:255',
            'cpns_sk' => 'required_if:_updating,"staffing"|string|max:255',
            'cpns_date' => 'required_if:_updating,"staffing"|date',
            'appointmen_sk' => 'required_if:_updating,"staffing"|string|max:255',
            'appointmen_mt' => 'required_if:_updating,"staffing"|date',
            'rank' => 'required_if:_updating,"staffing"|string|max:255',
            'source_salary' => 'required_if:_updating,"staffing"|string|max:255',
            'pns_mt' => 'required_if:_updating,"staffing"|date',
            'karpeg' => 'required_if:_updating,"staffing"|string|max:255',
            'karsu' => 'required_if:_updating,"staffing"|string|max:255',
            'nuks' => 'required_if:_updating,"staffing"|number|max:22',
            'is_licensed_as_principal' => 'required_if:_updating,"staffing"|boolean',
            'had_supervision' => 'required_if:_updating,"staffing"|boolean',
